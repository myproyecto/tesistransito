...
<html lang="es">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('img/multa.ico')); ?>">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="<?php echo e(asset('css/_all-skins.min.css')); ?>">
    <link rel="#" href="<?php echo e(asset('img/multas.png')); ?>">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo e(url('fallas/falla')); ?>"><i class="fa fa-check-square"></i> Infracciones</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo e(url('multas/multa')); ?>"><i class="fa fa-check-square"></i> Procesar Multa</a></li>
                <li><a href="<?php echo e(url('multas/policia')); ?>"><i class="fa fa-check-square"></i> Policia</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo e(url('ventas/venta')); ?>"><i class="fa fa-check-square"></i> Procesar Pagos</a></li>
                <li><a href="<?php echo e(url('pagos/conductor')); ?>"><i class="fa fa-check-square"></i> Conductores</a></li>
              </ul>
            </li>
