                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('login') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="login" type="login" class="form-control" name="login" value="<?php echo e(old('login')); ?>" required autofocus placeholder="Introduce tu E-Mail o Nombre de Usuario">
